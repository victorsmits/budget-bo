...
GEMINI_MAX_BATCH_SIZE = int(os.getenv("GEMINI_MAX_BATCH_SIZE", "50"))
GEMINI_DAILY_LIMIT = int(os.getenv("GEMINI_DAILY_LIMIT", "18"))
GEMINI_MIN_DELAY_SECONDS = float(os.getenv("GEMINI_MIN_DELAY_SECONDS", "12"))
ENRICH_MAX_WORKERS = int(os.getenv("ENRICH_MAX_WORKERS", "8"))
ENRICH_TARGET_API_CALLS_PER_JOB = int(os.getenv("ENRICH_TARGET_API_CALLS_PER_JOB", "2"))
