          ...
          <CardContent className="space-y-3 p-4">
            ...
            <div className="flex items-center justify-between border-t pt-3">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="icon" disabled={page <= 1} onClick={() => setParam("page", String(page - 1))}><ChevronLeft className="size-4" /></Button>
                <Button variant="outline" size="icon" disabled={page >= pages} onClick={() => setParam("page", String(page + 1))}><ChevronRight className="size-4" /></Button>
              </div>
            </div>
          </CardContent>
        </Card>
