...
const CRAGR_WEBSITES = [
  ...
  { value: "ca-anjoumaine", label: "Anjou Maine" },
  { value: "ca-aquitaine", label: "Aquitaine" },
  { value: "ca-auvergnerhonedalpes", label: "Auvergne Rhône Alpes" },
  { value: "ca-bretagnepaysdelaloire", label: "Bretagne Pays de Loire" },
  { value: "ca-centrefrance", label: "Centre France" },
  { value: "ca-centreouest", label: "Centre Ouest" },
  { value: "ca-champagnebourgogne", label: "Champagne Bourgogne" },
  { value: "ca-charenteperigord", label: "Charente Périgord" },
  ...
  { value: "ca-latouraineetdupoitou", label: "La Touraine et du Poitou" },
  { value: "ca-loirehauteloire", label: "Loire Haute Loire" },
  { value: "ca-lorraine", label: "Lorraine" },
  { value: "ca-martinique", label: "Martinique" },
  { value: "ca-morbihan", label: "Morbihan" },
  { value: "ca-nord", label: "Nord de France" },
  { value: "ca-norddefrance", label: "Nord de France (autre code)" },
  { value: "ca-normandie", label: "Normandie" },
  { value: "ca-paris", label: "Île-de-France" },
  { value: "ca-picardie", label: "Picardie" },
  { value: "ca-provencecotedazur", label: "Provence Côte d’Azur" },
  { value: "ca-pyreneesgascogne", label: "Pyrénées Gascogne" },
  { value: "ca-reunion", label: "La Réunion" },
  { value: "ca-sudmediterranee", label: "Sud Méditerranée" },
  { value: "ca-toulouse", label: "Toulouse 31" },
